...
public final class LegacyObserveWitherStormTrigger
        extends LegacyCriterionTrigger<LegacyObserveWitherStormTrigger.Instance> {

    public LegacyObserveWitherStormTrigger(ResourceLocation id) {
        super(id);
    }

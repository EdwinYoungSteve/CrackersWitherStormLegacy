...
public final class LegacyCuredSickenedMobTrigger
        extends LegacyCriterionTrigger<LegacyCuredSickenedMobTrigger.Instance> {

    public LegacyCuredSickenedMobTrigger(ResourceLocation id) {
        super(id);
    }

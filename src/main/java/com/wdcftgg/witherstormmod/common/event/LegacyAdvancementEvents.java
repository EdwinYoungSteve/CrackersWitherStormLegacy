...
public final class LegacyAdvancementEvents {
    ...
    private LegacyAdvancementEvents() {
    }
    ...
    public static void onWorldTick(TickEvent.WorldTickEvent event) {
        ...
        while (iterator.hasNext()) {
            ...
            EntityWitherStormLegacy storm = nearestStorm(event.world, player);
            if (storm != null) LegacyCriteriaTriggers.RING_BELL_NEAR_STORM.trigger(player, storm);
        }
    }
    ...
    private static EntityWitherStormLegacy nearestStorm(World world, EntityPlayerMP player) {
        ...
        List<EntityWitherStormLegacy> storms = world.getEntitiesWithinAABB(
                EntityWitherStormLegacy.class, area, storm -> !storm.isDead);

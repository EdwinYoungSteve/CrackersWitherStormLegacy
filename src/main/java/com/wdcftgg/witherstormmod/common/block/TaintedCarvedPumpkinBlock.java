...
public final class TaintedCarvedPumpkinBlock extends BlockHorizontal {
    ...
    public TaintedCarvedPumpkinBlock(String name, boolean lit) {
    ...
    private void trySpawnGolem(World world, BlockPos position) {
        ...
        if (match != null) {
            ...
            SickenedEntities.SickenedSnowGolemEntity golem = new SickenedEntities.SickenedSnowGolemEntity(world);
        ...
        SickenedEntities.SickenedIronGolemEntity golem = new SickenedEntities.SickenedIronGolemEntity(world);
        golem.setLocationAndAngles(spawnPosition.getX() + 0.5D, spawnPosition.getY() + 0.05D,
                spawnPosition.getZ() + 0.5D, 0.0F, 0.0F);
        world.spawnEntity(golem);

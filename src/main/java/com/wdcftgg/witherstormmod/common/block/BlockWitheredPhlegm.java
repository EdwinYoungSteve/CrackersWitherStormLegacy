...
public class BlockWitheredPhlegm extends BlockContainer {
    public static final PropertyBool POWERED = PropertyBool.create("powered");

    public BlockWitheredPhlegm(String name) {
        super(Material.CLAY);
    ...
    public TileEntity createNewTileEntity(World world, int metadata) {
        return new TileEntityWitheredPhlegm();
    }
    ...
    public boolean onBlockActivated(World world, BlockPos pos, IBlockState state, EntityPlayer player,
        ...
        if (!world.isRemote && world.getTileEntity(pos) instanceof TileEntityWitheredPhlegm) {
            player.openGui(WitherStormMod.INSTANCE, LegacyGuiHandler.WITHERED_PHLEGM, world,
    ...
    public void breakBlock(World world, BlockPos pos, IBlockState state) {
        ...
        if (tile instanceof TileEntityWitheredPhlegm) {
            InventoryHelper.dropInventoryItems(world, pos, (TileEntityWitheredPhlegm) tile);
    ...
    public int getComparatorInputOverride(IBlockState state, World world, BlockPos pos) {
        TileEntity tile = world.getTileEntity(pos);
        return tile instanceof TileEntityWitheredPhlegm
                ? Container.calcRedstoneFromInventory((TileEntityWitheredPhlegm) tile) : 0;
    }
    ...
    public void onBlockPlacedBy(World world, BlockPos pos, IBlockState state,
        ...
        if (stack.hasDisplayName()) {
            TileEntity tile = world.getTileEntity(pos);
            if (tile instanceof TileEntityWitheredPhlegm) {
                ((TileEntityWitheredPhlegm) tile).setCustomName(stack.getDisplayName());
            }
        }
    }
    ...
    public int getExpDrop(IBlockState state, IBlockAccess world, BlockPos pos, int fortune) {
        TileEntity tile = world.getTileEntity(pos);
        return tile instanceof TileEntityWitheredPhlegm
                ? ((TileEntityWitheredPhlegm) tile).getStoredExperience() : 0;
    }

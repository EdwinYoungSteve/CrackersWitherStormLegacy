...
public final class LegacyTaintedPumpkinBlock extends Block {

    public LegacyTaintedPumpkinBlock(String name) {
    ...
    public boolean onBlockActivated(World world, BlockPos position, IBlockState state, EntityPlayer player,
        ...
        if (!world.isRemote) {
            ...
            if (!(carvedBlock instanceof LegacyTaintedCarvedPumpkinBlock)) {

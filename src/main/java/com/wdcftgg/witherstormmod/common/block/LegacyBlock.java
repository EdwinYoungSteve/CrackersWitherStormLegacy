...
public class LegacyBlock extends Block {
    ...
    public LegacyBlock(String name, Material material, float hardness, float resistance) {
        this(name, material, hardness, resistance, SoundType.STONE);
    }

    public LegacyBlock(String name, Material material, float hardness, float resistance, SoundType soundType) {
        super(material);

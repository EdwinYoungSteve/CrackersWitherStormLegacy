...
public final class LegacyStrippableAxisBlock extends LegacyAxisBlock {

    private final String strippedBlockName;

    public LegacyStrippableAxisBlock(String name, String strippedBlockName) {
        super(name);
    ...
    IBlockState getStrippedState(IBlockState originalState) {
        ...
        if (!(strippedBlock instanceof LegacyAxisBlock)) {

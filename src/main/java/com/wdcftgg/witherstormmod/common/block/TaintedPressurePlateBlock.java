...
public class TaintedPressurePlateBlock extends BlockPressurePlate {

    public TaintedPressurePlateBlock(String name, Material material, Sensitivity sensitivity) {

...
public class LegacyWallBlock extends BlockWall {

    public LegacyWallBlock(String name, Block modelBlock) {
        super(modelBlock);
        ...
        setResistance(LegacyBlock.toLegacyResistance(cobblestone ? 6.0F : 0.8F));

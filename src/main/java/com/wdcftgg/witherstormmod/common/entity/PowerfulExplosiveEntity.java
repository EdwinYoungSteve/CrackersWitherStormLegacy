...
public abstract class PowerfulExplosiveEntity extends EntityTNTPrimed {
    ...
    public static class SuperTntEntity extends PowerfulExplosiveEntity {
        public SuperTntEntity(World world) { super(world); }
        public SuperTntEntity(World world, double positionX, double positionY, double positionZ, EntityLivingBase igniter) { super(world, positionX, positionY, positionZ, igniter); }
    ...
    public static class FormidibombEntity extends PowerfulExplosiveEntity implements FormidibombSource {
        ...
        @Override
        protected void explode() {
            FormidibombExplosion.explode(world, this, 48 + world.rand.nextInt(9), 3, posX, posY, posZ);

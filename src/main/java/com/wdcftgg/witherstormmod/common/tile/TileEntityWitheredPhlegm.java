...
public class TileEntityWitheredPhlegm extends TileEntityLockableLoot implements ITickable {
    ...
    public Container createContainer(InventoryPlayer playerInventory, EntityPlayer player) {
        return new ContainerWitheredPhlegm(playerInventory, this);
    }
    ...
    public void update() {
        ...
        if (state.getBlock() instanceof BlockWitheredPhlegm && state.getValue(BlockWitheredPhlegm.POWERED)) return;
    ...
    public void recheckOpen() {
        ...
        for (EntityPlayer player : world.playerEntities) {
            if (!player.isSpectator() && player.openContainer instanceof ContainerWitheredPhlegm
                    && ((ContainerWitheredPhlegm) player.openContainer).getPhlegmInventory() == this) {
                actual++;
            }
        }
        int previous = playersUsing;

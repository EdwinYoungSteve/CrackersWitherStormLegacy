...
public abstract class TileEntityAbstractSuperBeacon extends TileEntity {
    protected int ticks;
    ...
    protected final void tickBeaconBase() {
        ...
        if (world != null && !world.isRemote) {
            com.wdcftgg.witherstormmod.common.network.LegacyNetwork.updateDistantSuperBeacon(this);
    ...
    public boolean hasReachedPowerUpClimax() {
        return poweringUpAnimation <= LegacySuperBeaconLogic.POWER_UP_CLIMAX;
    }
    ...
    public void invalidate() {
        ...
        if (world != null && !world.isRemote) {
            com.wdcftgg.witherstormmod.common.network.LegacyNetwork.removeDistantSuperBeacon(this);
            com.wdcftgg.witherstormmod.common.world.LegacyChunkLoadingManager.INSTANCE

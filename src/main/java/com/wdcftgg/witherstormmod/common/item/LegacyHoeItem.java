...
public class LegacyHoeItem extends ItemHoe {
    private final float attackDamage;
    private final float attackSpeed;

    public LegacyHoeItem(String name, ToolMaterial material) {
        this(name, material, 0.0F, -3.0F);
    }

    public LegacyHoeItem(String name, ToolMaterial material, float attackDamage, float attackSpeed) {
        super(material);

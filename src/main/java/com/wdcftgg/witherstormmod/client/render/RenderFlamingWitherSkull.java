...
import com.wdcftgg.witherstormmod.client.model.ModelFlamingWitherSkullPort;
...
public class RenderFlamingWitherSkull<T extends EntityWitherSkull> extends Render<T> {

    private final ModelFlamingWitherSkullPort model = new ModelFlamingWitherSkullPort();
    private final ResourceLocation texture;
    private final ResourceLocation emissiveTexture;

    public RenderFlamingWitherSkull(RenderManager renderManager, String textureName) {
        super(renderManager);

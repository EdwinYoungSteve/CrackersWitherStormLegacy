...
public final class LayerWitheredSymbiontArmor extends LayerBipedArmor {
    public LayerWitheredSymbiontArmor(RenderWitheredSymbiont renderer) {
        super(renderer);
    }
    ...
    private static final class SymbiontArmorModel extends ModelBiped {
        ...
        public void setModelAttributes(ModelBase model) {
            ...
            if (model instanceof ModelWitheredSymbiontPort) {
                ((ModelWitheredSymbiontPort) model).copyBipedPoseTo(this);
            }
        }

...
public class SickenedIronGolemCracksLayer implements LayerRenderer<SickenedEntities.SickenedIronGolemEntity> {
    ...
    private final SickenedIronGolemRenderer renderer;

    public SickenedIronGolemCracksLayer(SickenedIronGolemRenderer renderer) {
        this.renderer = renderer;
    }

    @Override
    public void doRenderLayer(SickenedEntities.SickenedIronGolemEntity entity, float limbSwing, float limbSwingAmount,

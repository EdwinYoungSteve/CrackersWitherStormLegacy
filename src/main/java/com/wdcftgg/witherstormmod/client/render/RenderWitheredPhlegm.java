...
public class RenderWitheredPhlegm extends TileEntitySpecialRenderer<TileEntityWitheredPhlegm> {
    @Override
    public void render(TileEntityWitheredPhlegm tile, double x, double y, double z,

...
public class RenderTaintedSign extends TileEntitySpecialRenderer<TileEntityTaintedSign> {

    private static final ResourceLocation TEXTURE = new ResourceLocation("minecraft", "textures/entity/signs/tainted.png");
    private final ModelSign model = new ModelSign();

    @Override
    public void render(TileEntityTaintedSign sign, double x, double y, double z, float partialTicks, int destroyStage, float alpha) {

...
public class SickenedCreeperChargeLayer implements LayerRenderer<SickenedEntities.SickenedCreeperEntity> {
    private static final ResourceLocation TEXTURE = new ResourceLocation("textures/entity/creeper/creeper_armor.png");
    private final SickenedCreeperRenderer renderer;
    private final ModelCreeper model = new ModelCreeper(2.0F);

    public SickenedCreeperChargeLayer(SickenedCreeperRenderer renderer) {
        this.renderer = renderer;
    }

    @Override
    public void doRenderLayer(SickenedEntities.SickenedCreeperEntity entity, float limbSwing, float limbSwingAmount,

...
public class SickenedMushroomCowMushroomsLayer implements LayerRenderer<SickenedEntities.SickenedMushroomCowEntity> {
    private final SickenedMushroomCowRenderer renderer;

    public SickenedMushroomCowMushroomsLayer(SickenedMushroomCowRenderer renderer) {
        this.renderer = renderer;
    }

    @Override
    public void doRenderLayer(SickenedEntities.SickenedMushroomCowEntity entity, float limbSwing, float limbSwingAmount,

...
import com.wdcftgg.witherstormmod.client.model.ModelTentacleSpikePort;
...
public class RenderTentacleSpike extends Render<SupplementalEntities.TentacleSpike> {
    ...
    private final ModelTentacleSpikePort model = new ModelTentacleSpikePort();

    public RenderTentacleSpike(RenderManager renderManager) {
        super(renderManager);
    }

    @Override
    public void doRender(SupplementalEntities.TentacleSpike entity, double x, double y, double z,
    ...
    @Override
    protected ResourceLocation getEntityTexture(SupplementalEntities.TentacleSpike entity) {
        return TEXTURE;
    }
}

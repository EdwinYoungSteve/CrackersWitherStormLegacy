...
public class SickenedEmissiveLayer<T extends SickenedMobEntity> implements LayerRenderer<T> {

    private final SickenedMobRenderer<T> renderer;
    private final ResourceLocation texture;

    public SickenedEmissiveLayer(SickenedMobRenderer<T> renderer, ResourceLocation texture) {

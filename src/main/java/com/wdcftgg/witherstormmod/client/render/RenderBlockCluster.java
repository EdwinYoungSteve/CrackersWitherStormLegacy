...
public class RenderBlockCluster extends Render<SupplementalEntities.BlockCluster> {
    public RenderBlockCluster(RenderManager renderManager) {
        super(renderManager);
        shadowSize = 0.5F;
    }

    @Override
    public void doRender(SupplementalEntities.BlockCluster entity, double x, double y, double z,
    ...
    @Override
    protected ResourceLocation getEntityTexture(SupplementalEntities.BlockCluster entity) {

...
public final class WitherStormSegmentEmissiveLayer
        implements LayerRenderer<SupplementalEntities.WitherStormSegmentEntity> {
    private final WitherStormSegmentRenderer renderer;

    public WitherStormSegmentEmissiveLayer(WitherStormSegmentRenderer renderer) {
    ...
    public void doRenderLayer(SupplementalEntities.WitherStormSegmentEntity entity,
        ...
        WitherStormSegmentModel model = (WitherStormSegmentModel) renderer.getMainModel();
    ...
    private void endEmissive(SupplementalEntities.WitherStormSegmentEntity entity) {

...
public final class LayerWitheredSymbiontTear implements LayerRenderer<SickenedEntities.WitheredSymbiont> {
    private final RenderWitheredSymbiont renderer;

    public LayerWitheredSymbiontTear(RenderWitheredSymbiont renderer) {

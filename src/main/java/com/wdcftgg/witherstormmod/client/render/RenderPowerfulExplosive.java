...
public class RenderPowerfulExplosive<T extends EntityPowerfulExplosive> extends Render<T> {

    private final IBlockState renderedState;

    public RenderPowerfulExplosive(RenderManager renderManager, String blockName) {
        super(renderManager);
        shadowSize = 0.5F;

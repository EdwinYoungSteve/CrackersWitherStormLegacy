...
public class ModelSickenedVillagerPort extends ModelBiped {

    public ModelSickenedVillagerPort() {
    ...
    public void setRotationAngles(float limbSwing, float limbSwingAmount, float ageInTicks,
        ...
        boolean aggressive = entity instanceof EntitySickenedMob
                && ((EntitySickenedMob) entity).getAttackTarget() != null;

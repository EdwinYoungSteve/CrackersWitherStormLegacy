...
public class SickenedIronGolemModel extends ModelIronGolem {
    @Override
    public void setLivingAnimations(EntityLivingBase entity, float limbSwing, float limbSwingAmount, float partialTicks) {
        int attackTick = entity instanceof SickenedEntities.SickenedIronGolemEntity
                ? ((SickenedEntities.SickenedIronGolemEntity) entity).getAttackAnimationTick() : 0;
        if (attackTick > 0) {

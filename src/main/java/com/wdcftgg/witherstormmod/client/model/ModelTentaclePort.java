...
public class ModelTentaclePort extends ModelBase {

    private final ModelRenderer[] segments = new ModelRenderer[5];

    public ModelTentaclePort() {
        textureWidth = 128;
        textureHeight = 128;
    ...
    public void render(Entity entity, float partialTicks, float amount, float ageInTicks,
        ...
        if (entity instanceof SickenedEntities.Tentacle) {
            SickenedEntities.Tentacle tentacle = (SickenedEntities.Tentacle) entity;

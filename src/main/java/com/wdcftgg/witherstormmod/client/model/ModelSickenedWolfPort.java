...
public class ModelSickenedWolfPort extends ModelBase
{
    ...
    {
        SickenedEntities.SickenedWolf entitywolf = (SickenedEntities.SickenedWolf) entitylivingbaseIn;

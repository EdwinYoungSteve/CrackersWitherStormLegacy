...
public class ModelWitheredSymbiontPort extends ModelBiped {
    ...
    public ModelWitheredSymbiontPort() {
    ...
    public void setLivingAnimations(EntityLivingBase entity, float limbSwing, float limbSwingAmount,
        ...
        if (!(entity instanceof SickenedEntities.WitheredSymbiont)) return;

        SickenedEntities.WitheredSymbiont symbiont = (SickenedEntities.WitheredSymbiont) entity;
    ...
    public void setRotationAngles(float limbSwing, float limbSwingAmount, float ageInTicks,
        ...
        bipedRightArm.rotationPointY += crouchAnimation * 3.0F;

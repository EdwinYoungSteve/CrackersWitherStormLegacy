...
public class ModelSickenedCatPort extends ModelBase
{
    ...
    {
        SickenedEntities.SickenedCat entityocelot = (SickenedEntities.SickenedCat) entitylivingbaseIn;

...
public class GuiSuperBeacon extends GuiContainer {
    ...
    private final ContainerSuperBeacon container;
    ...
    public GuiSuperBeacon(ContainerSuperBeacon container, TileEntityAbstractSuperBeacon beacon) {
        super(container);
    ...
    protected void actionPerformed(GuiButton button) throws IOException {
        ...
        if (button instanceof EffectButton) {
            ...
            LegacyNetwork.setSuperBeaconEffect(Potion.getIdFromPotion(candidate));
            mc.player.closeScreen();
        } else if (button.id == 2) {
            LegacyNetwork.setSuperBeaconEffect(-1);
        } else if (button.id == 3) {
            showingInfo = true;
        } else if (button.id == 4) {
            LegacyNetwork.toggleSuperBeaconArea(!container.shouldShowArea());
            mc.player.closeScreen();
        } else if (button.id == 5) {
            showingInfo = false;
        }

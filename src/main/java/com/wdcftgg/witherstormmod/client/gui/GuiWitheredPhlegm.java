...
public class GuiWitheredPhlegm extends GuiContainer {
    ...
    public GuiWitheredPhlegm(ContainerWitheredPhlegm container, IInventory phlegmInventory) {
        super(container);
    ...
    protected void drawGuiContainerForegroundLayer(int mouseX, int mouseY) {
        ...
        int xp = ((ContainerWitheredPhlegm) inventorySlots).getXp();
        if (xp > 0) {

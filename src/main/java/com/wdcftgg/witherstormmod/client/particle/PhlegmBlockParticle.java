...
public class PhlegmBlockParticle extends Particle {
    ...
    private PhlegmBlockParticle(World world, double x, double y, double z,
    ...
    public static void spawnForBlock(World world, BlockPos pos, boolean powered, Random random) {
        ...
        for (int i = 0; i < count; i++) {
            ...
            minecraft.effectRenderer.addEffect(new PhlegmBlockParticle(world,
